...
package com.ysn.footballclub_dicoding.detailmatch.adapter
...
class AdapterMatch constructor(private var events: List<Event>,
                               private val listenerAdapterMatch: ListenerAdapterMatch) : RecyclerView.Adapter<AdapterMatch.ViewHolderItemPreviousMatch>() {
    ...
    fun refreshData(events: ArrayList<Event>) {
        this.events = events
