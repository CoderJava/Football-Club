...
package com.ysn.footballclubdicoding.model.matches

import com.google.gson.annotations.SerializedName
import java.io.Serializable

data class SearchLeagueMatches(
        @SerializedName("event") val eventMatches: List<EventSearchLeagueMatches>
)

data class EventSearchLeagueMatches(
